...
const CategoryChicken = ({getCategoryChicken}) => {
    return (
      ...
      <div className=" p-4  rounded-lg bg-white shadow-indigo-50 shadow-md">
            <div
               className="bg-gradient-to-tr from-indigo-500 to-indigo-400 ml-3 md:w-40 md:h-40 w-32 h-32 rounded-full shadow-2xl shadow-indigo-400 border-white overflow-hidden border-dashed border-2  flex justify-center items-center ">
               <div>
