...
const Profile = () => {
    ...
    return (
      <div className="flex flex-col  w-full p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">

        <div className="flex">
        <img src={logUser?.image} alt="profile" className="w-32 h-32  rounded-full dark:bg-gray-500 aspect-square" />
        <div className="text-content mx-5">
        <h1 className="indicator  tab tab-lifted tab-active"> 
        <span className="indicator-item badge badge-primary">{logUser?.role}</span> 
        <span className="text-xl px-4 text-start font-semibold sm:text-2xl">{logUser?.name}</span> 
        </h1>
        <h2 className="px-5 text-start text-xs font-semibold sm:text-base dark:text-gray-400">{logUser?.email}</h2>
        <p className="px-5 text-start text-xs sm:text-base dark:text-gray-400">Full-stack developer</p>
        </div>
        </div>
        ...
        <div className="my-2 space-y-1 ratting">
                ...
                <div className="flex flex-col mt-4">
                  <div className="flex items-center space-x-1">
                    ...
                    <div className="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-700">
                      <div className="dark:bg-orange-300  bg-green-700 h-4 w-5/6"></div>
                    </div>
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <div className="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-700">
                      <div className="dark:bg-orange-300  bg-green-700 h-4 w-4/6"></div>
                    </div>
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <div className="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-700">
                      <div className="dark:bg-orange-300  bg-green-700 h-4 w-3/6"></div>
                    </div>
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <div className="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-700">
                      <div className="dark:bg-orange-300  bg-green-700 h-4 w-2/6"></div>
                    </div>
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <div className="flex-1 h-4 overflow-hidden rounded-sm dark:bg-gray-700">
                      <div className="dark:bg-orange-300 bg-green-700 h-4 w-1/6"></div>
                    </div>
